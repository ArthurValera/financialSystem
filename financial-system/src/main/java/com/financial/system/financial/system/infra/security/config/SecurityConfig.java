...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilter securityFilter(TokenService tokenService, PersonDetailsService personDetailsService) {
        return new SecurityFilter(tokenService, personDetailsService);
    }
